...
========================================
Всім привіт) Вітаю у DOMi і з повернення до гіта. Звикайте вже знову із гітом знаходити спільну мову. У 6му модулі у вас є 10 супер задач і ми вже робимо зручний інтерфейс у кожному окремому файлі окреме завдання.
